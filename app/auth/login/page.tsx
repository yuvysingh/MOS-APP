    ...
    <div className='min-h-screen flex items-center justify-center'>
      <div className=' rounded-lg border border-gray-300 px-32 py-4'>
        <form className='flex flex-col justify-around gap-4'>
          <p className='text-center text-xl  text-gray-500 font-bold '>Login</p>
      ...
      <div className='flex justify-between'>
        ...
        <Link href='recover' className='text-center text-sm text-gray-800/60 hover:underline'>Forgot password?</Link>
      </div>
