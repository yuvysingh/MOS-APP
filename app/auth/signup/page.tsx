    ...
    <div className='min-h-screen flex items-center justify-center'>
      <div className=' rounded-lg border border-gray-300 px-32 py-4'>
        <form className='flex flex-col justify-around gap-4'>
          ...
          <div className='flex justify-end gap-x-2'>
            <label htmlFor="password2" className=' py-1 text-gray-500 font-bold'>Confirm Password:</label>
            <input id="password2" name="password2" type="password" className=' appearance-none py-1 px-4  border-gray-200 rounded border-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'   required />
          </div>
